...
const HomeScreen = () => {
  ...
  const { data: discountedProductsData, isLoading: discountedProductsLoading } = useQuery({
    queryKey: ['home-discounted-products', userId],
    queryFn: () => getProductApplyCP({ 
      limit: 4, 
      userId: userId,
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <Carousel 
        ...
        effect="fade" 
        autoplaySpeed={5000}
        className="homepage-hero-carousel"
      >
          ...
          <div key={item.id}>
            ...
            >
              ...
              <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-lg text-white p-6 rounded-lg bg-black bg-opacity-30 backdrop-blur-sm">
                  <Title level={1} className="text-white m-0 mb-2">{item.title}</Title>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="flex justify-between items-center mb-6">
            <Title level={2} className="m-0">Shop by Category</Title>
            <Button 
              type="link" 
        ...
        <div className="mb-16 bg-white p-8 rounded-lg shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center">
              ...
              <Title level={2} className="m-0">Featured Products</Title>
            </div>
            <Button 
              type="primary" 
              onClick={handleViewAllProducts}
...
/>
        ...
        <div className="mb-16">
          <div 
            ...
            style={{ backgroundImage: 'url(https://esmee.qodeinteractive.com/wp-content/uploads/2021/07/categories-4.jpg)' }}
          >
            <div className="absolute inset-0 bg-black bg-opacity-40"></div>
            <div className="relative z-10 p-8 max-w-lg">
              <Title level={2} className="text-white">Summer Sale</Title>
              <Text className="text-white text-lg block mb-4">Up to 50% off on selected items. Limited time offer.</Text>
              <Button 
                type="primary" 
                size="large"
        ...
        {/* Discounted Products */}
        {!discountedProductsLoading && discountedProductsData?.data?.length > 0 && (
          <div className="mb-16 bg-white p-8 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center">
                <FireOutlined className="text-red-500 text-xl mr-2" />
                <Title level={2} className="m-0">Hot Deals</Title>
              </div>
              <Button 
                type="link" 
                onClick={() => navigate('/products?sortBy=discount_desc')}
                className="flex items-center text-red-600"
              >
                View All Deals <RightOutlined />
              </Button>
            </div>

            <Row gutter={[16, 24]}>
              {discountedProductsData.data.map(product => (
                <Col xs={12} sm={8} md={6} key={product.id}>
                  <ProductCard
                    product={product}
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <Title level={2} className="text-white mb-6">Stay Updated</Title>
          <Text className="text-gray-300 text-lg block mb-8 max-w-2xl mx-auto">
          ...
          <div className="max-w-lg mx-auto flex flex-col sm:flex-row gap-2">
            <input 
              ...
              className="flex-1 p-3 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
